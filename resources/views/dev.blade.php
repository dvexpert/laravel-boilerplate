                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        @if (Route::has('login'))
                            <div class="flex justify-end">
                                <a href="{{ route('login') }}" class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]">Login</a>
                            </div>
                        @endif
                    </header>
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#4040c8" viewBox="0 0 80 80" size-5 sm:size-6><path d="M0 40a39.87 39.87 0 0 1 11.72-28.28A40 40 0 1 1 0 40zm34 10a4 4 0 0 1-4-4v-2a2 2 0 1 0-4 0v2a4 4 0 0 1-4 4h-2a2 2 0 1 0 0 4h2a4 4 0 0 1 4 4v2a2 2 0 1 0 4 0v-2a4 4 0 0 1 4-4h2a2 2 0 1 0 0-4h-2zm24-24a6 6 0 0 1-6-6v-3a3 3 0 0 0-6 0v3a6 6 0 0 1-6 6h-3a3 3 0 0 0 0 6h3a6 6 0 0 1 6 6v3a3 3 0 0 0 6 0v-3a6 6 0 0 1 6-6h3a3 3 0 0 0 0-6h-3zm-4 36a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM21 28a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path></svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Telescope</h2>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="175" height="90" viewBox="0 0 175 90" fill="none"> 
                                        <style> g path { fill: #000 } @media (prefers-color-scheme:dark) { g path { fill: #fff } } </style> 
                                        ...
                                        <defs>
                                        <linearGradient id="paint0_linear_3_15" x1="84.5" y1="5.99999" x2="84.5" y2="84.9999" gradientUnits="userSpaceOnUse"> <stop stop-color="#F85A5A"/> <stop offset="0.828125" stop-color="#7A5AF8"/> </linearGradient> </defs>
                                    </svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Laravel Pulse</h2>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="#4040c8" viewBox="0 0 80 80" size-5 sm:size-6><path d="M0 40a39.87 39.87 0 0 1 11.72-28.28A40 40 0 1 1 0 40zm34 10a4 4 0 0 1-4-4v-2a2 2 0 1 0-4 0v2a4 4 0 0 1-4 4h-2a2 2 0 1 0 0 4h2a4 4 0 0 1 4 4v2a2 2 0 1 0 4 0v-2a4 4 0 0 1 4-4h2a2 2 0 1 0 0-4h-2zm24-24a6 6 0 0 1-6-6v-3a3 3 0 0 0-6 0v3a6 6 0 0 1-6 6h-3a3 3 0 0 0 0 6h3a6 6 0 0 1 6 6v3a3 3 0 0 0 6 0v-3a6 6 0 0 1 6-6h3a3 3 0 0 0 0-6h-3zm-4 36a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM21 28a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path></svg> --}}
                                    <img src="/vendor/log-viewer/img/log-viewer-128.png" />
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">App Logs</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Implementation of <code>opcodesio/log-viewer</code>. Log Viewer is a package for Laravel allowing you to easily read, search and manage your Laravel logs.
                                    </p>
                                </div>
